...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            author = Config.author
                ...
                return citel.reply(media,{packname:'Astro',author:citel.pushName},"sticker")
        }
    )
    //---------------------------------------------------------------------------
cmd({
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            memek = await Void.sendImageAsSticker(citel.chat, meme, citel, { packname: citel.pushName, author: 'Astro' })
